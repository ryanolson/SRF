 ...
 * pointer to the coro::ThreadPool that was executing the coroutine upto the point it was suspended. Capturing this
 * information allows us to extend concept::awaiter objects to become concept::resumable objects where the programmer
 * can provide guidance on how and where a coroutine should be resumed.
 */
class ThreadLocalContext
{
  ...
  private:
    ...
    // not in a srf::coro::ThreadPool or if suspend_thread_local_context has not been called

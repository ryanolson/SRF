...
template <class Exp,
          ...
          class Ret = detail::decay_t<decltype(detail::invoke(std::declval<F>(), *std::declval<Exp>()))>,
          detail::enable_if_t<detail::is_expected<Ret>::value &&
                              std::is_convertible<decltype(std::declval<Exp>().error()), err_t<Ret>>::value>* = nullptr>
...
template <class Exp,
          ...
          class Result                                    = expected<Ret, err_t<Exp>>>
constexpr Result map_impl(Exp&& exp, F&& f)
{
...
constexpr Result map_impl(Exp&& exp, F&& f)
{
    return exp.has_value() ? (detail::invoke(std::forward<F>(f), *std::forward<Exp>(exp)), Result())
                           : Result(unexpect, std::forward<Exp>(exp).error());
}
...
constexpr Result map_impl(Exp&& exp, F&& f)
{
    return exp.has_value() ? (detail::invoke(std::forward<F>(f)), Result())
                           : Result(unexpect, std::forward<Exp>(exp).error());
}
                 ...
                 private detail::expected_default_ctor_base<T, E>
{
  ...
  public:
    ...
    template <class F>
    TL_EXPECTED_11_CONSTEXPR auto and_then(F&& f) & -> decltype(detail::and_then_impl(*this, std::forward<F>(f)))
    {
        return detail::and_then_impl(*this, std::forward<F>(f));
    }
    template <class F>
    TL_EXPECTED_11_CONSTEXPR auto and_then(F&& f) && -> decltype(detail::and_then_impl(std::move(*this),
                                                                                       std::forward<F>(f)))
    {
        return detail::and_then_impl(std::move(*this), std::forward<F>(f));
    }
    template <class F>
    constexpr auto and_then(F&& f) const& -> decltype(detail::and_then_impl(*this, std::forward<F>(f)))
    {
        return detail::and_then_impl(*this, std::forward<F>(f));
    }
    #ifndef TL_EXPECTED_NO_CONSTRR
    template <class F>
    constexpr auto and_then(F&& f) const&& -> decltype(detail::and_then_impl(std::move(*this), std::forward<F>(f)))
    {
        return detail::and_then_impl(std::move(*this), std::forward<F>(f));
    }
    #endif
    ...
    template <class F>
    TL_EXPECTED_11_CONSTEXPR auto map(F&& f) & -> decltype(detail::map_impl(*this, std::forward<F>(f)))
    {
        return detail::map_impl(*this, std::forward<F>(f));
    }
    template <class F>
    TL_EXPECTED_11_CONSTEXPR auto map(F&& f) && -> decltype(detail::map_impl(std::move(*this), std::forward<F>(f)))
    {
        return detail::map_impl(std::move(*this), std::forward<F>(f));
    }
    template <class F>
    constexpr auto map(F&& f) const& -> decltype(detail::map_impl(*this, std::forward<F>(f)))
    {
        return detail::map_impl(*this, std::forward<F>(f));
    }
    #ifndef TL_EXPECTED_NO_CONSTRR
    template <class F>
    constexpr auto map(F&& f) const&& -> decltype(detail::map_impl(std::move(*this), std::forward<F>(f)))
    {
        return detail::map_impl(std::move(*this), std::forward<F>(f));
    }
    #endif
    ...
    template <class F>
    TL_EXPECTED_11_CONSTEXPR auto transform(F&& f) & -> decltype(detail::map_impl(*this, std::forward<F>(f)))
    {
        return detail::map_impl(*this, std::forward<F>(f));
    }
    template <class F>
    TL_EXPECTED_11_CONSTEXPR auto transform(F&& f) && -> decltype(detail::map_impl(std::move(*this),
                                                                                   std::forward<F>(f)))
    {
        return detail::map_impl(std::move(*this), std::forward<F>(f));
    }
    template <class F>
    constexpr auto transform(F&& f) const& -> decltype(detail::map_impl(*this, std::forward<F>(f)))
    {
        return detail::map_impl(*this, std::forward<F>(f));
    }
    #ifndef TL_EXPECTED_NO_CONSTRR
    template <class F>
    constexpr auto transform(F&& f) const&& -> decltype(detail::map_impl(std::move(*this), std::forward<F>(f)))
    {
        return detail::map_impl(std::move(*this), std::forward<F>(f));
    }
    #endif
    ...
    template <class F>
    TL_EXPECTED_11_CONSTEXPR auto map_error(F&& f) & -> decltype(detail::map_error_impl(*this, std::forward<F>(f)))
    {
        return detail::map_error_impl(*this, std::forward<F>(f));
    }
    template <class F>
    TL_EXPECTED_11_CONSTEXPR auto map_error(F&& f) && -> decltype(detail::map_error_impl(std::move(*this),
                                                                                         std::forward<F>(f)))
    {
        return detail::map_error_impl(std::move(*this), std::forward<F>(f));
    }
    template <class F>
    constexpr auto map_error(F&& f) const& -> decltype(detail::map_error_impl(*this, std::forward<F>(f)))
    {
        return detail::map_error_impl(*this, std::forward<F>(f));
    }
    #ifndef TL_EXPECTED_NO_CONSTRR
    template <class F>
    constexpr auto map_error(F&& f) const&& -> decltype(detail::map_error_impl(std::move(*this), std::forward<F>(f)))
    {
        return detail::map_error_impl(std::move(*this), std::forward<F>(f));
    }
    #endif
    ...
    template <class F>
    TL_EXPECTED_11_CONSTEXPR auto or_else(F&& f) & -> decltype(detail::or_else_impl(*this, std::forward<F>(f)))
    {
        return detail::or_else_impl(*this, std::forward<F>(f));
    }
    template <class F>
    TL_EXPECTED_11_CONSTEXPR auto or_else(F&& f) && -> decltype(detail::or_else_impl(std::move(*this),
                                                                                     std::forward<F>(f)))
    {
        return detail::or_else_impl(std::move(*this), std::forward<F>(f));
    }
    template <class F>
    constexpr auto or_else(F&& f) const& -> decltype(detail::or_else_impl(*this, std::forward<F>(f)))
    {
        return detail::or_else_impl(*this, std::forward<F>(f));
    }
    #ifndef TL_EXPECTED_NO_CONSTRR
    template <class F>
    constexpr auto or_else(F&& f) const&& -> decltype(detail::or_else_impl(std::move(*this), std::forward<F>(f)))
    {
        return detail::or_else_impl(std::move(*this), std::forward<F>(f));
    }
    #endif

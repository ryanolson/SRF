...
#include "sre/coro/concepts/range_of.hpp"
...
class ThreadPool
{
  public:
     ...
     */
    class Operation : ThreadLocalState
    {
      ...
      private:
        ...
        trace::Handle<trace::Span> m_span{nullptr};
    };
     ...
     */
    template <coro::concepts::range_of<std::coroutine_handle<>> RangeT>
